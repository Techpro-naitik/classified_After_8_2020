...
@NgModule({
  ...
  imports: [
    ...
    JwPaginationModule,
    // AIzaSyD4RVjcsaMi7DCm12UFlQWl9UgqDZVJ8Mc
    //AIzaSyAKtu8yeyAPek9SCZNUBHIpKPEXKh2sajc
    // /AIzaSyBc48_rqAKG8YPcheR1j1aNFBUtUT20Sv8
    AgmCoreModule.forRoot({
      apiKey: 'AIzaSyAKtu8yeyAPek9SCZNUBHIpKPEXKh2sajc',
      libraries: ['places'],
    }),
  ...
  providers: [
    ...
    NgDynamicBreadcrumbServiceService,
    {
      ...
      useValue: {
        ...
        // {
       ...
       },
          {
            ...
            // 3458118904263858 
            //188108536296855
            provider: new FacebookLoginProvider('188108536296855')
          }
        ]
